...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_GRV , KC_SLSH, KC_ASTR, KC_LCBR, KC_RCBR, KC_UNDS,                   _______, KC_P7  , KC_P8  , KC_P9  , KC_P0  , KC_PGDN,
        _______, KC_MINS, KC_PLUS, KC_LPRN, KC_RPRN, KC_EQL ,                   _______, KC_P4  , KC_P5  , KC_P6  , KC_PLUS, KC_PIPE,
