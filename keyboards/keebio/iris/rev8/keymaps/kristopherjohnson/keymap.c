...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , LSFT_T(KC_ESC), RSFT_T(KC_TAB), KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                                            KC_LALT, KC_LGUI, KC_ENT        , KC_SPC        , TL_LOWR, TL_UPPR
    ),

    // lower
    [1] = LAYOUT(
        KC_TILD, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC,                                 KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PGUP,
        KC_GRV , KC_SLSH, KC_ASTR, KC_LCBR, KC_RCBR, KC_UNDS,                                 _______, KC_P7  , KC_P8  , KC_P9  , KC_PLUS, KC_PGDN,
        _______, KC_MINS, KC_PLUS, KC_LPRN, KC_RPRN, KC_EQL ,                                 _______, KC_P4  , KC_P5  , KC_P6  , KC_P0  , KC_PIPE,
        _______, KC_CAPS, CW_TOGG, KC_LBRC, KC_RBRC, KC_MINS, _______       , _______       , _______, KC_P1  , KC_P2  , KC_P3  , KC_MINS, _______,
    ...
    [2] = LAYOUT(
        ...
        _______, KC_MPRV, KC_MNXT, KC_VOLU, KC_PGUP, KC_UNDS,                                 KC_EQL , KC_HOME, KC_PGUP, KC_INS , KC_UP,   KC_DEL ,
        _______, KC_MSTP, KC_MPLY, KC_VOLD, KC_PGDN, KC_MINS, _______       , _______       , KC_PLUS, KC_END , KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT,
