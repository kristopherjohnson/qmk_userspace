...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______     , _______     , KC_LPRN     , KC_RPRN     , _______    ,                                 _______, KC_P4       , KC_P5       , KC_P6       , _______        , _______,
    ...
    [2] = LAYOUT(
        ...
        _______, _______     , _______     , _______     , _______     , _______    , _______       , _______       , _______, KC_END      , KC_PGDN     , KC_LEFT     , KC_DOWN        , KC_RGHT,
    ...
    [3] = LAYOUT(
        ...
        _______, _______     , _______     , _______     , _______     , _______    ,                                 _______, KC_PGUP     , KC_HOME     , KC_INS      , _______        , _______,
