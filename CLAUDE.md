...
- **rev8 (RP2040)**: the artifact is a `.uf2` (`keebio_iris_rev8_kristopherjohnson.uf2`, written to the repo root by a build; it is gitignored, not committed). Flash by copying the `.uf2` to the RP2040 mass-storage bootloader volume.
